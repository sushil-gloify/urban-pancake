<?php
    ...
    // $sectors = Order::getSectors();
    $client_id =$client['client_id'];
    // $client_id_decode = base64_decode($client_id);
    ...
    <div class="">
        <span class="pull-right">
            ...
            <?php
                ...
                $gridColumns = [
                        ...
                        'value' => function ($model) {
                            if($model->order_transfer == 2 || $model->order_transfer == ''){
                                if($model->fk_tbl_order_id_slot ==1 || $model->fk_tbl_order_id_slot ==2 || $model->fk_tbl_order_id_slot ==3 || $model->fk_tbl_order_id_slot == 6)
                                    ...
                                    return (!empty($model->delivery_date)) ? Common::mysqlDate($model->delivery_date) : Common::mysqlDate($model->delivery_datetime);
                                }
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            if($model->flight_number){
                                return strtoupper($model->flight_number);
                            } else {
                                return '-';
                            }
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            if($model->pnr_number){
                                return strtoupper($model->pnr_number);
                            } else {
                                return '-';
                            }
                    ...
                    [
                        ...
                        'label'=>'Slot',
                        'value' => function ($model) {
                            return !empty($model->fkTblOrderIdSlot) ? $model->fkTblOrderIdSlot->time_description : (isset($model->airport_slot_time) ? date('h:i:s A', strtotime($model->airport_slot_time)) : '-') ;
                        },
                    ],
                    [
            ...
            <?php
                ...
                $gridColumns1 = [
                            ['class' => 'yii\grid\SerialColumn'],
                                    ...
                                    [
                                        ...
                                        'filter'=>array('GOI'=>'GOI','COK'=>'COK','JAI'=>'JAI','HYD'=>'HYD','GAU'=>'GAU','IXR'=>'IXR','VTZ'=>'VTZ','BBI'=>'BBI','PNQ'=>'PNQ','IXC'=>'IXC','DEL'=>'DEL','BLR'=>'BLR','CCU'=>'CCU','SXR'=>'SXR','IXB'=>'IXB', 'IMF'=>'IMF'),
                                    ],
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) { 
                                            return $model->getDeliveryName($model->dservice_type);
                                        },
                                        // 'value' => function ($model) {
                                        //      return (($model->dservice_type == 1) ? "Repairs" :
                                        //       (($model->dservice_type == 2) ? "Reverse Pick Up" :
                                    ...
                                    [
                                        'attribute'=>'related_order_id',
                                        'format' => 'raw',
                                        'label'=>'Related <br> Order Status',
                                        'value' => function ($data, $key) { //print_r($data);exit;
                ...
                // $role_id=Yii::$app->user->identity->fk_tbl_employee_id_employee_role; 
                // if($role_id != 4)
                // User::downloadExportDataCorp($dataProvider,$gridColumns1,'Orders');    
                ?>
                <?php
                ...
                $gridColumns2 = [
                            ['class' => 'yii\grid\SerialColumn'],
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) { 
                                            return $model->travell_passenger_contact;
                                        },
                                    ],
                                    [
                                        'attribute'=>'flight_number',
                                    ...
                                    [
                                        ...
                                        'label'=>'Location/Area',
                                        'value' => function ($model) {
                                            return $model->getAreaName($model->id_order);
                                        },
                                    ],
                                    [
                                    ...
                                    [
                                        ...
                                        'header'=>'Assigned Person',
                                        'value' => function ($model) { 
                                            return $model->getAssignedPerson($model->id_order);
                                        },
                                    ],
                                    [
                                        'attribute'=>'fk_tbl_order_id_customer',
                                        ...
                                        'value' => function ($model) {
                                            return $model->getCustomerNumber($model->fk_tbl_order_id_customer);
                                        },
                                    ],
                                    [
                                        'attribute'=>'fk_tbl_order_id_customer',
                ...
                // $role_id=Yii::$app->user->identity->fk_tbl_employee_id_employee_role; 
                // if($role_id != 4)
                // User::downloadExportInsuranceData($dataProvider,$gridColumns2,'Orders');    
            ?>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'header' => 'Created By',
                'value' => function ($model) {
                    if(!empty($model->fkTblOrderIdCustomer)){
                        return !empty($model->fkTblOrderIdCustomer) ? $model->fkTblOrderIdCustomer->name : '-' ;
                        //return $model->travell_passenger_name ;
                    } else {
            ...
            [
                ...
                'value' => function ($model) {
                    ...
                    return (!empty($pincode)) ? $pincode : (isset($model->pickup_pincode) ? $model->pickup_pincode : '-'); 
                }
            ],
            [
                'attribute' => 'city_id',
                ...
                'value' => function ($model) {
                    ...
                    return (!empty($pincode)) ? $pincode : (!empty($model->drop_pincode) ? $model->drop_pincode : "-");
                }
            ],
            [
                'attribute'=>'fk_tbl_airport_of_operation_airport_name_id',
                ...
                'filter'=>array("3"=>"KIAL","4"=>"VOBG","7"=>"RGAI","5"=>"VOJK","6"=>"VOYK","8"=>"VODG","12"=> "T1 IGI - New Delhi","13"=> "T2 IGI - New Delhi","14"=> "T2 IGI - New Delhi","9"=>"T2 CSMIA Mumbai","8"=>"T1 CSMIA Mumbai"),
            ],
            [
                'attribute' => 'airport_service',
                'header' => 'Airport Service',
            ...
            //    'order_date', 
             //'sector',
                ...
                //'filter'=>array("1"=>"North","2"=>"Sorth","3"=>"East","4"=>"West","5"=>"North-East","6"=>"North-west","7"=>"South-East","8"=>"South-West","9"=>"Center"),
            [
                'attribute' => 'date_created',
                'header' => 'Date Of Booking',
                'value' => function ($model) {
            ...
            [
                ...
                'value' => function ($model) {
                     ...
                     if($model->order_transfer == 2 || $model->order_transfer == ''){
                        ...
                        {
                            return $model->departure_date." ".$model->departure_time;
                           // return $model->delivery_datetime = date("Y-m-d h:i ", strtotime($model->delivery_datetime));
                        } elseif($model->fk_tbl_order_id_slot==4){
                            
                            return  $model->order_date;
                        } else{
                            $arrival_date = strtotime("+1 day", strtotime($model->order_date));
            ...
            [
                ...
                'value' => function ($model) {
                    ...
                    return ($model->order_transfer == 2) ? (($model->meet_time_gate) ? date('h:i A', strtotime($model->meet_time_gate)) : '-') : '-';
                },
            ],
            /*[
                'attribute' => 'service_type',
            ...
            [
                ...
                'header'=>'Actions',
                'template' => '{update} {view} {delete} {employee/tman-corporate-order-update}',

                'buttons' => [
                    'update' => function ($url, $model){
                        return (Html::a('<span  class="glyphicon glyphicon-pencil"></span>',$url, ['title' => Yii::t('app', 'Update'), 'class'=>' btn-xs','id'=>$model->id_order,'onclick'=>"checkRazoreStatus($model->id_order);" ]));
                    },
                    ...
                    'employee/tman-corporate-order-update' => function ($url, $model) { 
                        if(Order::isItmanRealatedOrder($model->related_order_id) ==1 && $model->fk_tbl_order_id_slot == null){
                        
                            return Html::a('<span>Update</span>', $url, ['title' => Yii::t('app', 'Update'), 'class'=>'btn btn-warning btn-xs', ]); 
                        }
                    },
...
<script>
    ...
    function  getexportdata(){
        $.ajax({
            url  :'index.php?r=Order/getexportdata',
            success : function(data){
                console.log(data); console.log(co, 'count');
                $('.luggage_'+co).html(data);
            }
        });
    }
